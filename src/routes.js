...
const Routes = (props) => {
  return(
    <Layout>
      ...
      <PrivateRoute {...props} path="/admin_matches/add_players" exact component={AddEditPlayers}/>
      <PrivateRoute {...props} path="/admin_matches/add_players/:id" exact component={AddEditPlayers}/>
